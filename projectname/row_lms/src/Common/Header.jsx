    ...
    <nav className="bg-white border-gray-200  py-2.5 bg-white shadow-lg relative z-[999]">
        <div className="flex  justify-between items-center mx-auto ">
            ...
            <div className={`flex items-center lg:order-2 w-[84%] duration-[0.5s] ${changemenu==true ? 'w-[97%]' : 'w-[84%]'}  justify-between`}>
                ...
                <div>
                <button href="#" onClick={handleLogout} className="text-gray-800   focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log Out</button>
